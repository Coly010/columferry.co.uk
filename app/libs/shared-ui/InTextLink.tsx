...
export const InTextLink = ({children, baseTextSize, keepTextSize, ...props}: {
    children: React.ReactNode,
    baseTextSize: 'text-xs' | 'text-sm' | 'text-md' | 'text-lg' | 'text-xl' | 'text-2xl',
    ...
    return <a
        {...props}
        className={`${linkTextSize} font-bold underline decoration-emerald-500 text-emerald-500 underline-offset-4 transition hover:text-emerald-300 hover:decoration-emerald-300`}>{children}</a>
}