...
export default function Index() {
    return (
        <div className="my-10 text-slate-700">
            <h1 className="text-center sm:text-left text-3xl py-4 mt-4 font-bold animate__animated animate__fadeInUp animate__fast underline decoration-emerald-300 decoration-4">Hey,
                I'm
                Colum</h1>
            <img
            ...
            <div className="my-2 sm:my-8 text-slate-700 flex justify-between gap-2">
                <div className="w-full sm:w-1/2">
                    <h3 className="text-xl py-4 font-semibold animate__animated animate__fadeInUp animate__delay-1s">A
                        Senior Software
                        Engineer, building
                        monorepo tooling and build systems to help
                        your
                        projects scale with Typescript, Javascript, Node, Angular, React and Module Federation
                        at <InTextLink href="https://nx.dev" target="_blank" baseTextSize="text-xl">Nx</InTextLink>.
                    </h3>
                    <div className="text-lg py-4 animate__animated animate__fadeInUp animate__delay-2s">
                        ...
                        <p className="pt-6 font-light">Outside of work, I like to write fiction. You can find my first
                            book <InTextLink
                                ...
                                Blackstone Legacy</InTextLink> on Amazon. I'm currently working <HighlightedText>The
                                Dark War
