...
export const meta: MetaFunction = () => {
  return [
    { title: "Colum Ferry" },
    {
      name: "description",
      content:
        "Colum Ferry. Senior Software Engineer at Nx. Building monorepo tooling and build systems to help your projects scale without sacrificing Developer Experience. Building solutions both for and with Typescript, Javascript, Node, Angular, React, Module Federation, Bundlers.",
    },
  ];
};
...
export default function Index() {
  return (
    <div className="my-10 text-slate-700">
      <h1 className="text-center sm:text-left text-3xl py-4 mt-4 font-bold animate__animated animate__fadeInUp animate__fast underline decoration-emerald-300 decoration-4">
        Hey, I'm Colum
      </h1>
      <img
        className="block sm:hidden my-2 rounded-xl w-[120px] h-[120px] mx-auto animate__animated animate__fadeInUp animate__delay-1s animate__fast"
        src={MeSmall}
        alt="Colum Ferry speaking at Ng-DE"
      />
      <div className="my-2 sm:my-8 text-slate-700 flex justify-between gap-2">
        <div className="w-full sm:w-1/2">
          <h3 className="text-xl py-4 font-semibold animate__animated animate__fadeInUp animate__delay-1s">
          ...
          <div className="text-lg py-4 animate__animated animate__fadeInUp animate__delay-2s">
            ...
            <p className="pt-6 font-light">
              ...
              <InTextLink
                ...
                className="text-xl font-semibold underline decoration-emerald-500 decoration-4 text-emerald-500 underline-offset-4 transition hover:text-emerald-300 hover:decoration-emerald-300"
              >
        ...
        <div className="hidden sm:block animate__animated animate__fadeInUp animate__delay-1s animate__fast">
          <img
