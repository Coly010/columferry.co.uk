...
export const TodoContext = createContextId<TodoStore>('todo.context');
    ...
    Let’s update the root page to add our Context Provider.Open `apps/todo/src/root.tsx` and add `TodoContextProvider`
...
Also, if you liked this, click the 👏 and make sure to follow [Colum](https://twitter.com/FerryColum) and [Nx](https://twitter.com/nxdevtools) on X (formerly Twitter) for more!
